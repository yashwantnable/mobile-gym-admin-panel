    ...
    createRoutesFromElements(
      ...
      >
          ...
          <Route
            ...
            element={<ProtectedRoute children={<CurrencyMaster />} />}
          />
          <Route path='/masters/tax' element={<ProtectedRoute children={<TaxMaster />} />} />
          <Route
            path='/master/locations'
            element={<ProtectedRoute children={<LocationMaster />} />}
          />
          ...
          <Route
            ...
            element={<ProtectedRoute children={<SystemSettings />} />}
          />
        </Route>
