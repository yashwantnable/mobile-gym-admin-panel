    ...
    onSubmit: async (values) => {
      ...
      try {
        const res = selectedId
          ? await CategoryApi.updateCategory(selectedId, formData)
          ...
          <div className='flex items-center space-x-3 mt-2'>
            <button
              onClick={() => {
                ...
                setImagePreview(params.data.image || null);
              }}
            >
              <FaRegEdit />
            </button>
    ...
    <div className='p-5'>
      ...
      {open && (
        <SidebarField
          ...
          button1={<Button onClick={formik.handleSubmit} text={selectedId ? 'Update' : 'Save'} />}
