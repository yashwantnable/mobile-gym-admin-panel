...
const ServicesTable = React.memo(({ rowData, setOpen,setDeleteModal, setSid, subService, handleService }) => {
    const columns = [
        {
            headerName: "Image",
            field: "image",
            ...
            cellRenderer: (params) => (
                <div className="text-xl flex items-center py-2">
                    <button
                        ...
                        onClick={() => { setOpen(true); setSid(params?.data?._id) }}
                    >
                        <FaRegEdit />
                    </button>
                    <button
...
console.log("deleteModal:",deleteModal);
    ...
    useEffect(() => {
        if (singleService) {
            ...
            formik.setValues({
                ...
                serviceTypeId: singleService.serviceTypeId || "",
    ...
    const handleRemoveGroomingDetail = (index) => {
        const updatedDetails = formik.values.groomingDetails.filter(
            (_, i) => i !== index
        );
    ...
    return (
        <div className="p-5">
            ...
            <ServicesTable rowData={rowData} setDeleteModal={setDeleteModal} setOpen={setOpen} setSid={setSid} subService={subService} handleService={handleService} />
            {open && (
                <SidebarField
                    title={sId ?"Update Service":"Add New Service"}
                    handleClose={() => {
                        setOpen(false);
                        setImagePreview(null);
                        formik.resetForm();
                    ...
                    <form onSubmit={formik.handleSubmit} className="space-y-4">
                        ...
                        <div className="border p-4 rounded-lg">
                            ...
                            <InputField
                                ...
                                type="select"
                                options={[
                                    { label: "Under 10KG", value: "Under 10KG" },
                                    { label: "Over 10KG", value: "Over 10KG" },
                                ]}
                                ...
                                onBlur={formik.handleBlur}
                                error={formik.touched.weightType && formik.errors.weightType}
                                isRequired
                            />
                            <InputField
                                name="description"
                                label="Description (Add with comma seperated)"
                                type="textarea"
                            ...
                            <button
                                type="button"
                                onClick={handleAddGroomingDetail}
                                className="mt-4 flex cursor-pointer items-center gap-2 px-4 py-2 text-white bg-primary rounded-full"
                            >
                                <FaPlus /> Add Grooming Detail
                            </button>
                        </div>
            ...
            {openType && (
                <SidebarField
                    ...
                    button1={
                        <Button onClick={serviceTypeFormik.handleSubmit} text="Save" />
                    }
                    button2={
                        <Button
                            variant="outline"
                ...
                >
                    <form onSubmit={serviceTypeFormik.handleSubmit} className="space-y-4">
                        <div className="border p-4 cursor-pointer rounded-lg">
                            ...
                            {serviceTypeFormik.touched.image &&
                                serviceTypeFormik.errors.image && (
                        ...
                        <InputField
                            ...
                            error={
                                serviceTypeFormik.touched.name && serviceTypeFormik.errors.name
                            }
                            isRequired
                        />
                        ...
                        <InputField
                            ...
                            onBlur={serviceTypeFormik.handleBlur}
                            error={
                                serviceTypeFormik.touched.description &&
                                serviceTypeFormik.errors.description
                            }
                        />
                    </form>
                </SidebarField>
